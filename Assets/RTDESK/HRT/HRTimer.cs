...
public class HRTimer : RTTimer {
...
#if OS_MSWINDOWS
	public const HRT_Time HRT_MAX_TIME = RTT_MAXTIME;    //8 bytes

	//64 bits constants
	public const HRT_Time HRT_TIME_INVALID			= HRT_MAX_TIME;
	public const HRT_Time HRT_NOTIME				= 0L;
	public const HRT_Time HRT_INMEDIATELY			= 0L;
	public const HRT_Time HRT_ALMOST_INMEDIATELY	= 1L;
	...
	public void EndCounting (){FinalCounter = GetRealTime(); LastPeriod = FinalCounter - InitialCounter;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_Time TicksUntilNow () {EndCounting(); return LastPeriod;}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void ResetAccumulate(){Accumulated = 0; Periods = 0;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void InitCounting(){InitialCounter = GetRealTime(); FinalCounter = InitialCounter;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void Start(){InitCounting(); State = HRT_STATES.HRT_ACTIVE;}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_Time GetAccumulated () {return Accumulated;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_Time GetLastPeriod () {return LastPeriod;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_Time GetMaxPartial () {return MaxPartial;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_Time GetMinPartial () {return MinPartial;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public UInt32 GetPeriods () {return Periods;}
	
	//Next computations are multiplied by 1000 ms in a second
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double GetAccumulatedms () {return Ticks2ms(Accumulated);}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double GetLastPeriodms () {return Ticks2ms(LastPeriod);}
	
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double GetMaxPartialms () {return Ticks2ms(MaxPartial);}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public double GetMinPartialms () {return Ticks2ms(MinPartial);}
	
	//Alarms
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void SetAlarm(HRT_Time A) {AlarmPeriod = A; InitCounting();}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void SetAlarm (double A) {SetAlarm(ms2Ticks(A));}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_Time GetAlarmPeriod () {return AlarmPeriod;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double GetAlarmPeriodms () {return Ticks2ms(AlarmPeriod);}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool IsSounding () {EndCounting(); return AlarmPeriod < LastPeriod;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void StartSounding () {FinalCounter = GetRealTime();  InitialCounter = FinalCounter - AlarmPeriod;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void ResetAlarm () {InitCounting();}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void DisableAlarm () {AlarmPeriod = HRT_MAX_TIME;}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Boolean IsActive () {return HRT_STATES.HRT_ACTIVE == State;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Boolean isInActive () {return HRT_STATES.HRT_INACTIVE == State;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void SetState (HRT_STATES S) {State = S;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public HRT_STATES GetState () {return State;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void Activate () {if (isInActive()) Reset();}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public void DeActivate () {State = HRT_STATES.HRT_INACTIVE;}
	...
	public void DisplayHRTimerProperties(){
		...
		HRT_Time nanosecPerTick = 1000000000L / frequency;
		//UnityEngine.Debug.Log("  Timer is accurate within nanoseconds = " + nanosecPerTick.ToString());
	}
}
#endif