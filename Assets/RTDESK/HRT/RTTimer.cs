...
public class RTTimer {
	...
	public Stopwatch SW = Stopwatch.StartNew(); //WATCH OUT: do not use "new" because it does not start counting the watch
												//This implementation does not allow SW.Stop(); because the counting finishes

	protected	RTT_Time	SamplingFrequency, Time;
	public		Double		SFms, msXTick;            //Sampling frequency in ms. msXTick = 1/SFms
											//-----------------
	...
	*/
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public RTT_Time GetSF(){return SamplingFrequency;}

	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double Ticks2ms(RTT_Time T){return T*msXTick;}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public Double GetSamplingFreqms(){return SFms;}
